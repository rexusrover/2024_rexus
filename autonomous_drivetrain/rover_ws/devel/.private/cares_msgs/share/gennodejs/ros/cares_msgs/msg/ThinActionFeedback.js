...
class ThinActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ThinFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ThinFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ThinActionFeedback(null);
    ...
    data.feedback = ThinFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ThinActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ThinFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ThinFeedback()
    }
...
module.exports = ThinActionFeedback;
