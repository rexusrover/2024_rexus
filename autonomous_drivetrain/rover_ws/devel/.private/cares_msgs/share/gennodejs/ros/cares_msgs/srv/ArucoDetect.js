...
class ArucoDetectRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ArucoDetectRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ArucoDetectRequest
    let len;
    let data = new ArucoDetectRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArucoDetectRequest(null);
...
class ArucoDetectResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ArucoDetectResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ArucoDetectResponse
    let len;
    let data = new ArucoDetectResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArucoDetectResponse(null);
...
module.exports = {
  ...
  Response: ArucoDetectResponse,
  md5sum() { return '46b24f939212136602a01afc5ea1221e'; },
  datatype() { return 'cares_msgs/ArucoDetect'; }
};
