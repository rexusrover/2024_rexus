...
class ScanningActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ScanningGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ScanningGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ScanningActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ScanningGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ScanningGoal()
    }
...
module.exports = ScanningActionGoal;
