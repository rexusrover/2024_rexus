...
class MappingActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MappingFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MappingFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MappingActionFeedback(null);
    ...
    data.feedback = MappingFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MappingFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MappingActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MappingFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MappingFeedback()
    }
...
module.exports = MappingActionFeedback;
