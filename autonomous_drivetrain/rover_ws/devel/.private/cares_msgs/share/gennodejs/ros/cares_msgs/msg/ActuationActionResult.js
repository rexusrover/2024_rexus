...
class ActuationActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new ActuationResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ActuationResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuationActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ActuationResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ActuationResult()
    }
...
module.exports = ActuationActionResult;
