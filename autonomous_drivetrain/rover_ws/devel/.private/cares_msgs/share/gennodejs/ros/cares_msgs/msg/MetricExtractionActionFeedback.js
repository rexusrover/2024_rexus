...
class MetricExtractionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MetricExtractionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MetricExtractionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MetricExtractionActionFeedback(null);
    ...
    data.feedback = MetricExtractionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MetricExtractionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MetricExtractionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MetricExtractionFeedback()
    }
...
module.exports = MetricExtractionActionFeedback;
