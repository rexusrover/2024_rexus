...
class ScanningActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ScanningFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ScanningActionFeedback(null);
    ...
    data.feedback = ScanningFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ScanningActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ScanningFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ScanningFeedback()
    }
...
module.exports = ScanningActionFeedback;
