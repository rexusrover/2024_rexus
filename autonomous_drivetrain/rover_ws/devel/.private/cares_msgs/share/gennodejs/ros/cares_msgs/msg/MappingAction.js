...
class MappingAction {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new MappingActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new MappingActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new MappingActionFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MappingAction
    // Serialize message field [action_goal]
    bufferOffset = MappingActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = MappingActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = MappingActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MappingAction
    let len;
    let data = new MappingAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = MappingActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = MappingActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = MappingActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += MappingActionGoal.getMessageSize(object.action_goal);
    length += MappingActionResult.getMessageSize(object.action_result);
    length += MappingActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static md5sum() {
    ...
    return '1d01f4e9451b022cf7181e0f6c86b66f';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MappingAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = MappingActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new MappingActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = MappingActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new MappingActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = MappingActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new MappingActionFeedback()
    }
