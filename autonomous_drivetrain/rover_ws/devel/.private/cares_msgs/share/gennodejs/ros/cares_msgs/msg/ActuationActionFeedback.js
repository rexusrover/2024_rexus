...
class ActuationActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ActuationFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ActuationFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuationActionFeedback(null);
    ...
    data.feedback = ActuationFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuationActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ActuationFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ActuationFeedback()
    }
...
module.exports = ActuationActionFeedback;
