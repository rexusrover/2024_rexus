...
class ThinActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ThinGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ThinGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ThinActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ThinGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ThinGoal()
    }
