...
class ThinActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ThinResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ThinResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ThinActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ThinResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ThinResult()
    }
...
module.exports = ThinActionResult;
