...
class MappingActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MappingGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MappingGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MappingActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MappingGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MappingGoal()
    }
...
module.exports = MappingActionGoal;
