...
class ActuationAction {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('action_goal')) {
        ...
        this.action_goal = new ActuationActionGoal();
      }
      if (initObj.hasOwnProperty('action_result')) {
        this.action_result = initObj.action_result
      }
      else {
        this.action_result = new ActuationActionResult();
      }
      if (initObj.hasOwnProperty('action_feedback')) {
        this.action_feedback = initObj.action_feedback
      }
      else {
        this.action_feedback = new ActuationActionFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ActuationAction
    // Serialize message field [action_goal]
    bufferOffset = ActuationActionGoal.serialize(obj.action_goal, buffer, bufferOffset);
    // Serialize message field [action_result]
    bufferOffset = ActuationActionResult.serialize(obj.action_result, buffer, bufferOffset);
    // Serialize message field [action_feedback]
    bufferOffset = ActuationActionFeedback.serialize(obj.action_feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ActuationAction
    let len;
    let data = new ActuationAction(null);
    // Deserialize message field [action_goal]
    data.action_goal = ActuationActionGoal.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_result]
    data.action_result = ActuationActionResult.deserialize(buffer, bufferOffset);
    // Deserialize message field [action_feedback]
    data.action_feedback = ActuationActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += ActuationActionGoal.getMessageSize(object.action_goal);
    length += ActuationActionResult.getMessageSize(object.action_result);
    length += ActuationActionFeedback.getMessageSize(object.action_feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuationAction(null);
    if (msg.action_goal !== undefined) {
      resolved.action_goal = ActuationActionGoal.Resolve(msg.action_goal)
    }
    else {
      resolved.action_goal = new ActuationActionGoal()
    }

    if (msg.action_result !== undefined) {
      resolved.action_result = ActuationActionResult.Resolve(msg.action_result)
    }
    else {
      resolved.action_result = new ActuationActionResult()
    }

    if (msg.action_feedback !== undefined) {
      resolved.action_feedback = ActuationActionFeedback.Resolve(msg.action_feedback)
    }
    else {
      resolved.action_feedback = new ActuationActionFeedback()
    }
...
module.exports = ActuationAction;
