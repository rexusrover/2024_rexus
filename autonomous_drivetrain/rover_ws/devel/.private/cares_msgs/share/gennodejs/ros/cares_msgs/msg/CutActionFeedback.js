...
class CutActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CutFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CutActionFeedback(null);
    ...
    data.feedback = CutFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CutActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CutFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CutFeedback()
    }
...
module.exports = CutActionFeedback;
