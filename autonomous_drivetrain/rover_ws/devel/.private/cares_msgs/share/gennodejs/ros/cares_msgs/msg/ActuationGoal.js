...
class ActuationGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.approach_pose = null;
      this.target_constraints = null;
      this.approach_constraints = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('approach_pose')) {
        this.approach_pose = initObj.approach_pose
      }
      else {
        this.approach_pose = new geometry_msgs.msg.PoseStamped();
      }
      if (initObj.hasOwnProperty('target_constraints')) {
        this.target_constraints = initObj.target_constraints
      }
      else {
        this.target_constraints = new PathPlanningConstraints();
      }
      if (initObj.hasOwnProperty('approach_constraints')) {
        this.approach_constraints = initObj.approach_constraints
      }
      else {
        this.approach_constraints = new PathPlanningConstraints();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [approach_pose]
    bufferOffset = geometry_msgs.msg.PoseStamped.serialize(obj.approach_pose, buffer, bufferOffset);
    // Serialize message field [target_constraints]
    bufferOffset = PathPlanningConstraints.serialize(obj.target_constraints, buffer, bufferOffset);
    // Serialize message field [approach_constraints]
    bufferOffset = PathPlanningConstraints.serialize(obj.approach_constraints, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ActuationGoal(null);
    ...
    // Deserialize message field [approach_pose]
    data.approach_pose = geometry_msgs.msg.PoseStamped.deserialize(buffer, bufferOffset);
    // Deserialize message field [target_constraints]
    data.target_constraints = PathPlanningConstraints.deserialize(buffer, bufferOffset);
    // Deserialize message field [approach_constraints]
    data.approach_constraints = PathPlanningConstraints.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.link_id);
    length += geometry_msgs.msg.PoseStamped.getMessageSize(object.target_pose);
    length += geometry_msgs.msg.PoseStamped.getMessageSize(object.approach_pose);
    length += PathPlanningConstraints.getMessageSize(object.target_constraints);
    length += PathPlanningConstraints.getMessageSize(object.approach_constraints);
    return length + 5;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActuationGoal(null);
    ...
    if (msg.approach_pose !== undefined) {
      resolved.approach_pose = geometry_msgs.msg.PoseStamped.Resolve(msg.approach_pose)
    }
    else {
      resolved.approach_pose = new geometry_msgs.msg.PoseStamped()
    }

    if (msg.target_constraints !== undefined) {
      resolved.target_constraints = PathPlanningConstraints.Resolve(msg.target_constraints)
    }
    else {
      resolved.target_constraints = new PathPlanningConstraints()
    }

    if (msg.approach_constraints !== undefined) {
      resolved.approach_constraints = PathPlanningConstraints.Resolve(msg.approach_constraints)
    }
    else {
      resolved.approach_constraints = new PathPlanningConstraints()
    }
...
ActuationGoal.Constants = {
  STOP: 0,
  MOVE: 1,
  ACTUATE: 2,
}

module.exports = ActuationGoal;
