...
class CutActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CutGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += CutGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CutActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CutGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CutGoal()
    }
