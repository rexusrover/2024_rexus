...
class CutActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CutResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += CutResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CutActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = CutResult.Resolve(msg.result)
    }
    else {
      resolved.result = new CutResult()
    }
...
module.exports = CutActionResult;
