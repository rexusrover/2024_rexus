...
(cl:defclass <PathPlanningConstraints> (roslisp-msg-protocol:ros-message)
  ((orientation_constraint_type
   ...
   (volume_constraint_type
    :reader volume_constraint_type
    :initarg :volume_constraint_type
    :type cl:fixnum
    :initform 0)
   ...
   (replanning_multiplier
    :reader replanning_multiplier
    :initarg :replanning_multiplier
    :type cl:float
    :initform 0.0)
   (max_planning_time
    :reader max_planning_time
    :initarg :max_planning_time
    :type cl:float
    :initform 0.0)
   (path_constraints
...
(cl:defclass PathPlanningConstraints (<PathPlanningConstraints>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <PathPlanningConstraints>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'PathPlanningConstraints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cares_msgs-msg:<PathPlanningConstraints> is deprecated: use cares_msgs-msg:PathPlanningConstraints instead.")))

(cl:ensure-generic-function 'orientation_constraint_type-val :lambda-list '(m))
(cl:defmethod orientation_constraint_type-val ((m <PathPlanningConstraints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cares_msgs-msg:orientation_constraint_type-val is deprecated.  Use cares_msgs-msg:orientation_constraint_type instead.")
  (orientation_constraint_type m))

(cl:ensure-generic-function 'volume_constraint_type-val :lambda-list '(m))
(cl:defmethod volume_constraint_type-val ((m <PathPlanningConstraints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cares_msgs-msg:volume_constraint_type-val is deprecated.  Use cares_msgs-msg:volume_constraint_type instead.")
  (volume_constraint_type m))

(cl:ensure-generic-function 'allowed_planning_time-val :lambda-list '(m))
(cl:defmethod allowed_planning_time-val ((m <PathPlanningConstraints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cares_msgs-msg:allowed_planning_time-val is deprecated.  Use cares_msgs-msg:allowed_planning_time instead.")
  (allowed_planning_time m))

(cl:ensure-generic-function 'max_retries-val :lambda-list '(m))
(cl:defmethod max_retries-val ((m <PathPlanningConstraints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cares_msgs-msg:max_retries-val is deprecated.  Use cares_msgs-msg:max_retries instead.")
  (max_retries m))

(cl:ensure-generic-function 'replanning_multiplier-val :lambda-list '(m))
(cl:defmethod replanning_multiplier-val ((m <PathPlanningConstraints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cares_msgs-msg:replanning_multiplier-val is deprecated.  Use cares_msgs-msg:replanning_multiplier instead.")
  (replanning_multiplier m))

(cl:ensure-generic-function 'max_planning_time-val :lambda-list '(m))
(cl:defmethod max_planning_time-val ((m <PathPlanningConstraints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cares_msgs-msg:max_planning_time-val is deprecated.  Use cares_msgs-msg:max_planning_time instead.")
  (max_planning_time m))

(cl:ensure-generic-function 'path_constraints-val :lambda-list '(m))
(cl:defmethod path_constraints-val ((m <PathPlanningConstraints>))
  ...
  (path_constraints m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<PathPlanningConstraints>)))
    "Constants for message type '<PathPlanningConstraints>"
  '((:DEFAULT_ORIENT . 0)
    (:NO_ORIENT . 1)
    (:FIXED_ORIENT . 2)
    (:BETWEEN_ORIENT . 3)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <PathPlanningConstraints>) ostream)
  "Serializes a message object of type '<PathPlanningConstraints>"
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'orientation_constraint_type)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'volume_constraint_type)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'max_retries)) ostream)
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'replanning_multiplier))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'max_planning_time))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PathPlanningConstraints>) istream)
  "Deserializes a message object of type '<PathPlanningConstraints>"
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'orientation_constraint_type)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'volume_constraint_type)) (cl:read-byte istream))
    (cl:let ((bits 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'max_retries)) (cl:read-byte istream))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'replanning_multiplier) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <PathPlanningConstraints>))
  "Converts a ROS message object to a list"
  (cl:list 'PathPlanningConstraints
    (cl:cons ':orientation_constraint_type (orientation_constraint_type msg))
    (cl:cons ':volume_constraint_type (volume_constraint_type msg))
    (cl:cons ':allowed_planning_time (allowed_planning_time msg))
    (cl:cons ':max_retries (max_retries msg))
    (cl:cons ':replanning_multiplier (replanning_multiplier msg))
    (cl:cons ':max_planning_time (max_planning_time msg))
