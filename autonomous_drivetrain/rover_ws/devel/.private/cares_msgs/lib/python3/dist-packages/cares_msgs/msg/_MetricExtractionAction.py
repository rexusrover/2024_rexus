...
"""autogenerated by genpy from cares_msgs/MetricExtractionAction.msg. Do not edit."""
import codecs
import sys
...
class MetricExtractionAction(genpy.Message):
  _md5sum = "15db5c0d780c3baee6348caf51b17053"
  _type = "cares_msgs/MetricExtractionAction"
...
"""
  ...
  _slot_types = ['cares_msgs/MetricExtractionActionGoal','cares_msgs/MetricExtractionActionResult','cares_msgs/MetricExtractionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MetricExtractionAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cares_msgs.msg.MetricExtractionActionGoal()
      if self.action_result is None:
        self.action_result = cares_msgs.msg.MetricExtractionActionResult()
      if self.action_feedback is None:
        self.action_feedback = cares_msgs.msg.MetricExtractionActionFeedback()
    else:
      self.action_goal = cares_msgs.msg.MetricExtractionActionGoal()
      self.action_result = cares_msgs.msg.MetricExtractionActionResult()
      self.action_feedback = cares_msgs.msg.MetricExtractionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_goal.goal.file_path.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      buff.write(_get_struct_B().pack(_x))
      length = len(self.action_result.result.vine.cane_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.vine.cane_list:
        _x = val1
        ...
        for val3 in _v2.neighbours:
          _x = val3
          buff.write(_get_struct_I2d().pack(_x.neighbour_id, _x.internode_length, _x.internode_width))
      length = len(self.action_result.result.fruitlets.fruitlets)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.fruitlets.fruitlets:
        _x = val1.ID
        buff.write(_get_struct_B().pack(_x))
        _v4 = val1.centroid
        _x = _v4
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.result.point_cloud.header.seq, _x.action_result.result.point_cloud.header.stamp.secs, _x.action_result.result.point_cloud.header.stamp.nsecs))
      _x = self.action_result.result.point_cloud.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.action_result.result.point_cloud.height, _x.action_result.result.point_cloud.width))
      length = len(self.action_result.result.point_cloud.fields)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.point_cloud.fields:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self
      buff.write(_get_struct_B2I().pack(_x.action_result.result.point_cloud.is_bigendian, _x.action_result.result.point_cloud.point_step, _x.action_result.result.point_cloud.row_step))
      _x = self.action_result.result.point_cloud.data
      length = len(_x)
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_result.result.point_cloud.is_dense, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3B().pack(_x.action_feedback.feedback.status, _x.action_feedback.feedback.processed, _x.action_feedback.feedback.queued))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.file_path.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.file_path.data = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.vine.cane_list = []
      for i in range(0, length):
        ...
        self.action_result.result.vine.cane_list.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.fruitlets.fruitlets = []
      for i in range(0, length):
        ...
        self.action_result.result.fruitlets.fruitlets.append(val1)
      _x = self
      start = end
      end += 12
      (_x.action_result.result.point_cloud.header.seq, _x.action_result.result.point_cloud.header.stamp.secs, _x.action_result.result.point_cloud.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.point_cloud.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.point_cloud.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.action_result.result.point_cloud.height, _x.action_result.result.point_cloud.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.point_cloud.fields = []
      for i in range(0, length):
        ...
        self.action_result.result.point_cloud.fields.append(val1)
      _x = self
      start = end
      end += 9
      (_x.action_result.result.point_cloud.is_bigendian, _x.action_result.result.point_cloud.point_step, _x.action_result.result.point_cloud.row_step,) = _get_struct_B2I().unpack(str[start:end])
      self.action_result.result.point_cloud.is_bigendian = bool(self.action_result.result.point_cloud.is_bigendian)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.action_result.result.point_cloud.data = str[start:end]
      _x = self
      start = end
      end += 13
      (_x.action_result.result.point_cloud.is_dense, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      self.action_result.result.point_cloud.is_dense = bool(self.action_result.result.point_cloud.is_dense)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.status, _x.action_feedback.feedback.processed, _x.action_feedback.feedback.queued,) = _get_struct_3B().unpack(str[start:end])
      return self
