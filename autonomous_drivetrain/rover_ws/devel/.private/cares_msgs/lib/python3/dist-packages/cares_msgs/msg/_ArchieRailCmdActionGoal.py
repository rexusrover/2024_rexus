...
"""autogenerated by genpy from cares_msgs/ArchieRailCmdActionGoal.msg. Do not edit."""
import codecs
import sys
...
class ArchieRailCmdActionGoal(genpy.Message):
  _md5sum = "adfcfc0c505e0dc98e2ede65fe9fed19"
  _type = "cares_msgs/ArchieRailCmdActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','cares_msgs/ArchieRailCmdGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArchieRailCmdActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = cares_msgs.msg.ArchieRailCmdGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = cares_msgs.msg.ArchieRailCmdGoal()
