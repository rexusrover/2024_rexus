...
"""autogenerated by genpy from cares_msgs/ScanningAction.msg. Do not edit."""
import codecs
import sys
...
class ScanningAction(genpy.Message):
  _md5sum = "ac47112a155230cff991f708e9233b56"
  _type = "cares_msgs/ScanningAction"
...
"""
  ...
  _slot_types = ['cares_msgs/ScanningActionGoal','cares_msgs/ScanningActionResult','cares_msgs/ScanningActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ScanningAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cares_msgs.msg.ScanningActionGoal()
      if self.action_result is None:
        self.action_result = cares_msgs.msg.ScanningActionResult()
      if self.action_feedback is None:
        self.action_feedback = cares_msgs.msg.ScanningActionFeedback()
    else:
      self.action_goal = cares_msgs.msg.ScanningActionGoal()
      self.action_result = cares_msgs.msg.ScanningActionResult()
      self.action_feedback = cares_msgs.msg.ScanningActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B3I().pack(_x.action_goal.goal.command, _x.action_goal.goal.marker_type, _x.action_goal.goal.pose.header.seq, _x.action_goal.goal.pose.header.stamp.secs, _x.action_goal.goal.pose.header.stamp.nsecs))
      ...
      _x = self.action_goal.goal.planning_link.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.action_feedback.feedback.status, _x.action_feedback.feedback.arm_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.command, _x.action_goal.goal.marker_type, _x.action_goal.goal.pose.header.seq, _x.action_goal.goal.pose.header.stamp.secs, _x.action_goal.goal.pose.header.stamp.nsecs,) = _get_struct_2B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.planning_link.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.planning_link.data = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.status, _x.action_feedback.feedback.arm_status,) = _get_struct_2B().unpack(str[start:end])
      return self
