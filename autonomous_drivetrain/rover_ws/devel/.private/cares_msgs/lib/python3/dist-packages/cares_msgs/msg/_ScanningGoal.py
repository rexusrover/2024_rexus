...
"""autogenerated by genpy from cares_msgs/ScanningGoal.msg. Do not edit."""
import codecs
import sys
...
class ScanningGoal(genpy.Message):
  _md5sum = "e318ff248a9956ef2cf074c8e1f2c43d"
  _type = "cares_msgs/ScanningGoal"
...
"""
  ...
  __slots__ = ['command','marker_type','pose','rail_pose','rail_marker_target','planning_link','world_link','file_path','path_constraints']
  _slot_types = ['uint8','uint8','geometry_msgs/PoseStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','std_msgs/String','std_msgs/String','std_msgs/String','cares_msgs/PathPlanningConstraints']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       command,marker_type,pose,rail_pose,rail_marker_target,planning_link,world_link,file_path,path_constraints
    ...
    """
    if args or kwds:
      super(ScanningGoal, self).__init__(*args, **kwds)
      ...
      if self.planning_link is None:
        self.planning_link = std_msgs.msg.String()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2B3I().pack(_x.command, _x.marker_type, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.pose.pose.position.x, _x.pose.pose.position.y, _x.pose.pose.position.z, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w, _x.rail_pose.header.seq, _x.rail_pose.header.stamp.secs, _x.rail_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.command, _x.marker_type, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_2B3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.planning_link.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.planning_link.data = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
