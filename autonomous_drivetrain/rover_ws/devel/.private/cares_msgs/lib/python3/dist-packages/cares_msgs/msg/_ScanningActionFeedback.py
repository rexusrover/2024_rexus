...
"""autogenerated by genpy from cares_msgs/ScanningActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ScanningActionFeedback(genpy.Message):
  _md5sum = "8dfb3ff11fdd9bd4617204b718e3ec93"
  _type = "cares_msgs/ScanningActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/ScanningFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ScanningActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cares_msgs.msg.ScanningFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cares_msgs.msg.ScanningFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.feedback.status, _x.feedback.arm_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.status, _x.feedback.arm_status,) = _get_struct_2B().unpack(str[start:end])
      return self
