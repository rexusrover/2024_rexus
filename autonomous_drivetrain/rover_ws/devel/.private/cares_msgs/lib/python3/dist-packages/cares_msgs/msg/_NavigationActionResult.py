...
"""autogenerated by genpy from cares_msgs/NavigationActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigationActionResult(genpy.Message):
  ...
  _type = "cares_msgs/NavigationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/NavigationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = cares_msgs.msg.NavigationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cares_msgs.msg.NavigationResult()
