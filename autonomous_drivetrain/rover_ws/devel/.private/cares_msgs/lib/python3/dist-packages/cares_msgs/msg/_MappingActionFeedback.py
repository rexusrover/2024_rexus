...
"""autogenerated by genpy from cares_msgs/MappingActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MappingActionFeedback(genpy.Message):
  _md5sum = "8cc2175b0bca810e824bfd29a93a82bf"
  _type = "cares_msgs/MappingActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/MappingFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MappingActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cares_msgs.msg.MappingFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cares_msgs.msg.MappingFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(_x))
      length = len(self.feedback.scanning_feedback)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.scanning_feedback:
        _x = val1
        buff.write(_get_struct_2B().pack(_x.status, _x.arm_status))
      length = len(self.feedback.metric_feedback)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.metric_feedback:
        _x = val1
        buff.write(_get_struct_3B().pack(_x.status, _x.processed, _x.queued))
      _x = self
      buff.write(_get_struct_2B().pack(_x.feedback.count, _x.feedback.total))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.scanning_feedback = []
      for i in range(0, length):
        ...
        self.feedback.scanning_feedback.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.metric_feedback = []
      for i in range(0, length):
        ...
        self.feedback.metric_feedback.append(val1)
      _x = self
      start = end
      end += 2
      (_x.feedback.count, _x.feedback.total,) = _get_struct_2B().unpack(str[start:end])
      return self
