...
"""autogenerated by genpy from cares_msgs/ActuationActionGoal.msg. Do not edit."""
import codecs
import sys
...
class ActuationActionGoal(genpy.Message):
  _md5sum = "3ff1cb1d797ee926fdc12adf28336501"
  _type = "cares_msgs/ActuationActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','cares_msgs/ActuationGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActuationActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = cares_msgs.msg.ActuationGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = cares_msgs.msg.ActuationGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.goal.target_pose.pose.position.x, _x.goal.target_pose.pose.position.y, _x.goal.target_pose.pose.position.z, _x.goal.target_pose.pose.orientation.x, _x.goal.target_pose.pose.orientation.y, _x.goal.target_pose.pose.orientation.z, _x.goal.target_pose.pose.orientation.w, _x.goal.approach_pose.header.seq, _x.goal.approach_pose.header.stamp.secs, _x.goal.approach_pose.header.stamp.nsecs))
      _x = self.goal.approach_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d2BdB2d().pack(_x.goal.approach_pose.pose.position.x, _x.goal.approach_pose.pose.position.y, _x.goal.approach_pose.pose.position.z, _x.goal.approach_pose.pose.orientation.x, _x.goal.approach_pose.pose.orientation.y, _x.goal.approach_pose.pose.orientation.z, _x.goal.approach_pose.pose.orientation.w, _x.goal.target_constraints.orientation_constraint_type, _x.goal.target_constraints.volume_constraint_type, _x.goal.target_constraints.allowed_planning_time, _x.goal.target_constraints.max_retries, _x.goal.target_constraints.replanning_multiplier, _x.goal.target_constraints.max_planning_time))
      _x = self.goal.target_constraints.path_constraints.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.goal.target_constraints.path_constraints.joint_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.target_constraints.path_constraints.joint_constraints:
        _x = val1.joint_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.goal.target_constraints.path_constraints.position_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.target_constraints.path_constraints.position_constraints:
        _v1 = val1.header
        _x = _v1.seq
      ...
      length = len(self.goal.target_constraints.path_constraints.orientation_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.target_constraints.path_constraints.orientation_constraints:
        _v9 = val1.header
        _x = _v9.seq
        buff.write(_get_struct_I().pack(_x))
        _v10 = _v9.stamp
      ...
      length = len(self.goal.target_constraints.path_constraints.visibility_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.target_constraints.path_constraints.visibility_constraints:
      ...
      _x = self
      buff.write(_get_struct_2BdB2d().pack(_x.goal.approach_constraints.orientation_constraint_type, _x.goal.approach_constraints.volume_constraint_type, _x.goal.approach_constraints.allowed_planning_time, _x.goal.approach_constraints.max_retries, _x.goal.approach_constraints.replanning_multiplier, _x.goal.approach_constraints.max_planning_time))
      _x = self.goal.approach_constraints.path_constraints.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.goal.approach_constraints.path_constraints.joint_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.approach_constraints.path_constraints.joint_constraints:
        _x = val1.joint_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1
        buff.write(_get_struct_4d().pack(_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight))
      length = len(self.goal.approach_constraints.path_constraints.position_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.approach_constraints.path_constraints.position_constraints:
        _v24 = val1.header
        _x = _v24.seq
        buff.write(_get_struct_I().pack(_x))
        _v25 = _v24.stamp
        ...
        _x = val1.weight
        buff.write(_get_struct_d().pack(_x))
      length = len(self.goal.approach_constraints.path_constraints.orientation_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.approach_constraints.path_constraints.orientation_constraints:
        _v32 = val1.header
        _x = _v32.seq
        buff.write(_get_struct_I().pack(_x))
        _v33 = _v32.stamp
        ...
        _x = val1
        buff.write(_get_struct_3dBd().pack(_x.absolute_x_axis_tolerance, _x.absolute_y_axis_tolerance, _x.absolute_z_axis_tolerance, _x.parameterization, _x.weight))
      length = len(self.goal.approach_constraints.path_constraints.visibility_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.approach_constraints.path_constraints.visibility_constraints:
        _x = val1.target_radius
        buff.write(_get_struct_d().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.link_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.link_id = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.goal.approach_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.approach_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 83
      (_x.goal.approach_pose.pose.position.x, _x.goal.approach_pose.pose.position.y, _x.goal.approach_pose.pose.position.z, _x.goal.approach_pose.pose.orientation.x, _x.goal.approach_pose.pose.orientation.y, _x.goal.approach_pose.pose.orientation.z, _x.goal.approach_pose.pose.orientation.w, _x.goal.target_constraints.orientation_constraint_type, _x.goal.target_constraints.volume_constraint_type, _x.goal.target_constraints.allowed_planning_time, _x.goal.target_constraints.max_retries, _x.goal.target_constraints.replanning_multiplier, _x.goal.target_constraints.max_planning_time,) = _get_struct_7d2BdB2d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.target_constraints.path_constraints.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.target_constraints.path_constraints.name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.target_constraints.path_constraints.joint_constraints = []
      for i in range(0, length):
        ...
        self.goal.target_constraints.path_constraints.joint_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.target_constraints.path_constraints.position_constraints = []
      for i in range(0, length):
        ...
        self.goal.target_constraints.path_constraints.position_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.target_constraints.path_constraints.orientation_constraints = []
      for i in range(0, length):
        ...
        self.goal.target_constraints.path_constraints.orientation_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.target_constraints.path_constraints.visibility_constraints = []
      for i in range(0, length):
        ...
        self.goal.target_constraints.path_constraints.visibility_constraints.append(val1)
      _x = self
      start = end
      end += 27
      (_x.goal.approach_constraints.orientation_constraint_type, _x.goal.approach_constraints.volume_constraint_type, _x.goal.approach_constraints.allowed_planning_time, _x.goal.approach_constraints.max_retries, _x.goal.approach_constraints.replanning_multiplier, _x.goal.approach_constraints.max_planning_time,) = _get_struct_2BdB2d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.approach_constraints.path_constraints.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.approach_constraints.path_constraints.name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.approach_constraints.path_constraints.joint_constraints = []
      for i in range(0, length):
        val1 = moveit_msgs.msg.JointConstraint()
        start = end
        end += 4
        ...
        (_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight,) = _get_struct_4d().unpack(str[start:end])
        self.goal.approach_constraints.path_constraints.joint_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.approach_constraints.path_constraints.position_constraints = []
      for i in range(0, length):
        val1 = moveit_msgs.msg.PositionConstraint()
        _v70 = val1.header
        start = end
        ...
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.goal.approach_constraints.path_constraints.position_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.approach_constraints.path_constraints.orientation_constraints = []
      for i in range(0, length):
        val1 = moveit_msgs.msg.OrientationConstraint()
        _v78 = val1.header
        start = end
        ...
        (_x.absolute_x_axis_tolerance, _x.absolute_y_axis_tolerance, _x.absolute_z_axis_tolerance, _x.parameterization, _x.weight,) = _get_struct_3dBd().unpack(str[start:end])
        self.goal.approach_constraints.path_constraints.orientation_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.approach_constraints.path_constraints.visibility_constraints = []
      for i in range(0, length):
        val1 = moveit_msgs.msg.VisibilityConstraint()
        start = end
        end += 8
        ...
        (_x.max_view_angle, _x.max_range_angle, _x.sensor_view_direction, _x.weight,) = _get_struct_2dBd().unpack(str[start:end])
        self.goal.approach_constraints.path_constraints.visibility_constraints.append(val1)
      return self
