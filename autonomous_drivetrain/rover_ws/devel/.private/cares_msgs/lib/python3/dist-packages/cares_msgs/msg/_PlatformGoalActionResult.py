...
"""autogenerated by genpy from cares_msgs/PlatformGoalActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlatformGoalActionResult(genpy.Message):
  _md5sum = "ad835a7f878e12df3262ce2c756e9c93"
  _type = "cares_msgs/PlatformGoalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/PlatformGoalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlatformGoalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cares_msgs.msg.PlatformGoalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cares_msgs.msg.PlatformGoalResult()
