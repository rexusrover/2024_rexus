...
"""autogenerated by genpy from cares_msgs/MetricExtractionResult.msg. Do not edit."""
import codecs
import sys
...
class MetricExtractionResult(genpy.Message):
  _md5sum = "c2a9ce6ac04d25549c31e0c74e3f8c2d"
  _type = "cares_msgs/MetricExtractionResult"
...
"""
  __slots__ = ['result','vine','fruitlets','point_cloud']
  _slot_types = ['uint8','cares_msgs/Vine','cares_msgs/Fruitlets','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       result,vine,fruitlets,point_cloud
    ...
    """
    if args or kwds:
      super(MetricExtractionResult, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.result is None:
        self.result = 0
      if self.vine is None:
        self.vine = cares_msgs.msg.Vine()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.vine.cane_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.vine.cane_list:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.vine.cane_list.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
