...
"""autogenerated by genpy from cares_msgs/MappingActionResult.msg. Do not edit."""
import codecs
import sys
...
class MappingActionResult(genpy.Message):
  _md5sum = "d6bb15f97ff839d3aaad6cdeb6d81aa0"
  _type = "cares_msgs/MappingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/MappingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MappingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cares_msgs.msg.MappingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cares_msgs.msg.MappingResult()
