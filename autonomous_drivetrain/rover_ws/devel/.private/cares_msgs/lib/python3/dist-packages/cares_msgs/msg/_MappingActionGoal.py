...
"""autogenerated by genpy from cares_msgs/MappingActionGoal.msg. Do not edit."""
import codecs
import sys
...
class MappingActionGoal(genpy.Message):
  _md5sum = "092ad9a7687723a1c8db979c3576639e"
  _type = "cares_msgs/MappingActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','cares_msgs/MappingGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MappingActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = cares_msgs.msg.MappingGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = cares_msgs.msg.MappingGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B3I().pack(_x.goal.get_marker.data, _x.goal.path_id, _x.goal.init_pose.header.seq, _x.goal.init_pose.header.stamp.secs, _x.goal.init_pose.header.stamp.nsecs))
      _x = self.goal.init_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.goal.init_pose.pose.position.x, _x.goal.init_pose.pose.position.y, _x.goal.init_pose.pose.position.z, _x.goal.init_pose.pose.orientation.x, _x.goal.init_pose.pose.orientation.y, _x.goal.init_pose.pose.orientation.z, _x.goal.init_pose.pose.orientation.w, _x.goal.rail_pose.header.seq, _x.goal.rail_pose.header.stamp.secs, _x.goal.rail_pose.header.stamp.nsecs))
      _x = self.goal.rail_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d3I().pack(_x.goal.rail_pose.point.x, _x.goal.rail_pose.point.y, _x.goal.rail_pose.point.z, _x.goal.rail_marker_target.header.seq, _x.goal.rail_marker_target.header.stamp.secs, _x.goal.rail_marker_target.header.stamp.nsecs))
      _x = self.goal.rail_marker_target.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.goal.rail_marker_target.point.x, _x.goal.rail_marker_target.point.y, _x.goal.rail_marker_target.point.z))
      length = len(self.goal.scanning_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.scanning_goals:
        _x = val1
      ...
      _x = self.goal.metric_goal.command
      buff.write(_get_struct_B().pack(_x))
      _x = self.goal.metric_goal.file_path.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2BdB2d().pack(_x.goal.path_constraints.orientation_constraint_type, _x.goal.path_constraints.volume_constraint_type, _x.goal.path_constraints.allowed_planning_time, _x.goal.path_constraints.max_retries, _x.goal.path_constraints.replanning_multiplier, _x.goal.path_constraints.max_planning_time))
      _x = self.goal.path_constraints.path_constraints.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.goal.path_constraints.path_constraints.joint_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.path_constraints.path_constraints.joint_constraints:
        _x = val1.joint_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1
        buff.write(_get_struct_4d().pack(_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight))
      length = len(self.goal.path_constraints.path_constraints.position_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.path_constraints.path_constraints.position_constraints:
        _v43 = val1.header
        _x = _v43.seq
        buff.write(_get_struct_I().pack(_x))
        _v44 = _v43.stamp
        ...
        _x = val1.weight
        buff.write(_get_struct_d().pack(_x))
      length = len(self.goal.path_constraints.path_constraints.orientation_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.path_constraints.path_constraints.orientation_constraints:
        _v51 = val1.header
        _x = _v51.seq
        buff.write(_get_struct_I().pack(_x))
        _v52 = _v51.stamp
        ...
        _x = val1
        buff.write(_get_struct_3dBd().pack(_x.absolute_x_axis_tolerance, _x.absolute_y_axis_tolerance, _x.absolute_z_axis_tolerance, _x.parameterization, _x.weight))
      length = len(self.goal.path_constraints.path_constraints.visibility_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.path_constraints.path_constraints.visibility_constraints:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.world_link.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.world_link.data = str[start:end]
      _x = self
      start = end
      end += 14
      (_x.goal.get_marker.data, _x.goal.path_id, _x.goal.init_pose.header.seq, _x.goal.init_pose.header.stamp.secs, _x.goal.init_pose.header.stamp.nsecs,) = _get_struct_2B3I().unpack(str[start:end])
      self.goal.get_marker.data = bool(self.goal.get_marker.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.init_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.init_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.goal.init_pose.pose.position.x, _x.goal.init_pose.pose.position.y, _x.goal.init_pose.pose.position.z, _x.goal.init_pose.pose.orientation.x, _x.goal.init_pose.pose.orientation.y, _x.goal.init_pose.pose.orientation.z, _x.goal.init_pose.pose.orientation.w, _x.goal.rail_pose.header.seq, _x.goal.rail_pose.header.stamp.secs, _x.goal.rail_pose.header.stamp.nsecs,) = _get_struct_7d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.rail_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.rail_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.goal.rail_pose.point.x, _x.goal.rail_pose.point.y, _x.goal.rail_pose.point.z, _x.goal.rail_marker_target.header.seq, _x.goal.rail_marker_target.header.stamp.secs, _x.goal.rail_marker_target.header.stamp.nsecs,) = _get_struct_3d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.rail_marker_target.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.rail_marker_target.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 24
      (_x.goal.rail_marker_target.point.x, _x.goal.rail_marker_target.point.y, _x.goal.rail_marker_target.point.z,) = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.scanning_goals = []
      for i in range(0, length):
        ...
        self.goal.scanning_goals.append(val1)
      start = end
      end += 1
      (self.goal.metric_goal.command,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.metric_goal.file_path.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.metric_goal.file_path.data = str[start:end]
      _x = self
      start = end
      end += 27
      (_x.goal.path_constraints.orientation_constraint_type, _x.goal.path_constraints.volume_constraint_type, _x.goal.path_constraints.allowed_planning_time, _x.goal.path_constraints.max_retries, _x.goal.path_constraints.replanning_multiplier, _x.goal.path_constraints.max_planning_time,) = _get_struct_2BdB2d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.path_constraints.path_constraints.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.path_constraints.path_constraints.name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.path_constraints.path_constraints.joint_constraints = []
      for i in range(0, length):
        ...
        (_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight,) = _get_struct_4d().unpack(str[start:end])
        self.goal.path_constraints.path_constraints.joint_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.path_constraints.path_constraints.position_constraints = []
      for i in range(0, length):
        ...
        self.goal.path_constraints.path_constraints.position_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.path_constraints.path_constraints.orientation_constraints = []
      for i in range(0, length):
        ...
        (_x.absolute_x_axis_tolerance, _x.absolute_y_axis_tolerance, _x.absolute_z_axis_tolerance, _x.parameterization, _x.weight,) = _get_struct_3dBd().unpack(str[start:end])
        self.goal.path_constraints.path_constraints.orientation_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.path_constraints.path_constraints.visibility_constraints = []
      for i in range(0, length):
        ...
        (_x.max_view_angle, _x.max_range_angle, _x.sensor_view_direction, _x.weight,) = _get_struct_2dBd().unpack(str[start:end])
        self.goal.path_constraints.path_constraints.visibility_constraints.append(val1)
      return self
