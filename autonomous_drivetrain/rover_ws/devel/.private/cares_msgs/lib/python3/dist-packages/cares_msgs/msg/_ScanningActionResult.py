...
"""autogenerated by genpy from cares_msgs/ScanningActionResult.msg. Do not edit."""
import codecs
import sys
...
class ScanningActionResult(genpy.Message):
  _md5sum = "d6bb15f97ff839d3aaad6cdeb6d81aa0"
  _type = "cares_msgs/ScanningActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/ScanningResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ScanningActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cares_msgs.msg.ScanningResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cares_msgs.msg.ScanningResult()
