...
"""autogenerated by genpy from cares_msgs/ThinActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ThinActionFeedback(genpy.Message):
  _md5sum = "04e84d449e9469aed91577ca81835106"
  _type = "cares_msgs/ThinActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/ThinFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ThinActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cares_msgs.msg.ThinFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cares_msgs.msg.ThinFeedback()
