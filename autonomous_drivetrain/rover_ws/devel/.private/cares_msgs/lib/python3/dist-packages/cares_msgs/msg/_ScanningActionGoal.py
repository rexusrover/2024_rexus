...
"""autogenerated by genpy from cares_msgs/ScanningActionGoal.msg. Do not edit."""
import codecs
import sys
...
class ScanningActionGoal(genpy.Message):
  _md5sum = "0a4c3af17b53ccab43854f56048ebbfb"
  _type = "cares_msgs/ScanningActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','cares_msgs/ScanningGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ScanningActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = cares_msgs.msg.ScanningGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = cares_msgs.msg.ScanningGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B3I().pack(_x.goal.command, _x.goal.marker_type, _x.goal.pose.header.seq, _x.goal.pose.header.stamp.secs, _x.goal.pose.header.stamp.nsecs))
      ...
      _x = self.goal.planning_link.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.command, _x.goal.marker_type, _x.goal.pose.header.seq, _x.goal.pose.header.stamp.secs, _x.goal.pose.header.stamp.nsecs,) = _get_struct_2B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.planning_link.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.planning_link.data = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.file_path.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.file_path.data = str[start:end]
      _x = self
      start = end
      end += 27
