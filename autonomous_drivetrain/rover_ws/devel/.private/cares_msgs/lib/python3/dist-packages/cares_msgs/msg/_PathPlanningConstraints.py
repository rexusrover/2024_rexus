...
"""autogenerated by genpy from cares_msgs/PathPlanningConstraints.msg. Do not edit."""
import codecs
import sys
...
class PathPlanningConstraints(genpy.Message):
  _md5sum = "d902e08c4f7b8ac5f42349a281e44e8e"
  _type = "cares_msgs/PathPlanningConstraints"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Orientation Constraint Type
...
"""
  ...
  __slots__ = ['orientation_constraint_type','volume_constraint_type','allowed_planning_time','max_retries','replanning_multiplier','max_planning_time','path_constraints']
  _slot_types = ['uint8','uint8','float64','uint8','float64','float64','moveit_msgs/Constraints']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       orientation_constraint_type,volume_constraint_type,allowed_planning_time,max_retries,replanning_multiplier,max_planning_time,path_constraints
    ...
    """
    if args or kwds:
      super(PathPlanningConstraints, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.orientation_constraint_type is None:
        self.orientation_constraint_type = 0
      if self.volume_constraint_type is None:
        self.volume_constraint_type = 0
      if self.allowed_planning_time is None:
        self.allowed_planning_time = 0.
      if self.max_retries is None:
        self.max_retries = 0
      if self.replanning_multiplier is None:
        self.replanning_multiplier = 0.
      if self.max_planning_time is None:
        self.max_planning_time = 0.
