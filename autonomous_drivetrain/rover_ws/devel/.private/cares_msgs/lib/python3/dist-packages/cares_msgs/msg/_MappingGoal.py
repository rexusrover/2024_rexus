...
class MappingGoal(genpy.Message):
  _md5sum = "c90de59715eb776b6c453bc2795855ee"
...
"""
  ...
  __slots__ = ['command','world_link','get_marker','path_id','init_pose','rail_pose','rail_marker_target','scanning_goals','metric_goal','path_constraints']
  _slot_types = ['uint8','std_msgs/String','std_msgs/Bool','uint8','geometry_msgs/PoseStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','cares_msgs/ScanningGoal[]','cares_msgs/MetricExtractionGoal','cares_msgs/PathPlanningConstraints']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       command,world_link,get_marker,path_id,init_pose,rail_pose,rail_marker_target,scanning_goals,metric_goal,path_constraints
    ...
    if args or kwds:
      ...
      if self.world_link is None:
        self.world_link = std_msgs.msg.String()
      if self.get_marker is None:
        self.get_marker = std_msgs.msg.Bool()
      if self.path_id is None:
        self.path_id = 0
      if self.init_pose is None:
        self.init_pose = geometry_msgs.msg.PoseStamped()
      if self.rail_pose is None:
        self.rail_pose = geometry_msgs.msg.PointStamped()
      if self.rail_marker_target is None:
        self.rail_marker_target = geometry_msgs.msg.PointStamped()
      ...
      if self.path_constraints is None:
        self.path_constraints = cares_msgs.msg.PathPlanningConstraints()
    else:
      self.command = 0
      self.world_link = std_msgs.msg.String()
      self.get_marker = std_msgs.msg.Bool()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B3I().pack(_x.get_marker.data, _x.path_id, _x.init_pose.header.seq, _x.init_pose.header.stamp.secs, _x.init_pose.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.init_pose.pose.position.x, _x.init_pose.pose.position.y, _x.init_pose.pose.position.z, _x.init_pose.pose.orientation.x, _x.init_pose.pose.orientation.y, _x.init_pose.pose.orientation.z, _x.init_pose.pose.orientation.w, _x.rail_pose.header.seq, _x.rail_pose.header.stamp.secs, _x.rail_pose.header.stamp.nsecs))
      _x = self.rail_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d3I().pack(_x.rail_pose.point.x, _x.rail_pose.point.y, _x.rail_pose.point.z, _x.rail_marker_target.header.seq, _x.rail_marker_target.header.stamp.secs, _x.rail_marker_target.header.stamp.nsecs))
      _x = self.rail_marker_target.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.rail_marker_target.point.x, _x.rail_marker_target.point.y, _x.rail_marker_target.point.z))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2BdB2d().pack(_x.path_constraints.orientation_constraint_type, _x.path_constraints.volume_constraint_type, _x.path_constraints.allowed_planning_time, _x.path_constraints.max_retries, _x.path_constraints.replanning_multiplier, _x.path_constraints.max_planning_time))
      _x = self.path_constraints.path_constraints.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.path_constraints.path_constraints.joint_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.path_constraints.path_constraints.joint_constraints:
        _x = val1.joint_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1
        buff.write(_get_struct_4d().pack(_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight))
      length = len(self.path_constraints.path_constraints.position_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.path_constraints.path_constraints.position_constraints:
        _v43 = val1.header
        _x = _v43.seq
        buff.write(_get_struct_I().pack(_x))
        _v44 = _v43.stamp
        ...
        _x = val1.weight
        buff.write(_get_struct_d().pack(_x))
      length = len(self.path_constraints.path_constraints.orientation_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.path_constraints.path_constraints.orientation_constraints:
        _v51 = val1.header
        _x = _v51.seq
        buff.write(_get_struct_I().pack(_x))
        _v52 = _v51.stamp
        ...
        _x = val1
        buff.write(_get_struct_3dBd().pack(_x.absolute_x_axis_tolerance, _x.absolute_y_axis_tolerance, _x.absolute_z_axis_tolerance, _x.parameterization, _x.weight))
      length = len(self.path_constraints.path_constraints.visibility_constraints)
      buff.write(_struct_I.pack(length))
      for val1 in self.path_constraints.path_constraints.visibility_constraints:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.world_link.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.world_link.data = str[start:end]
      _x = self
      start = end
      end += 14
      (_x.get_marker.data, _x.path_id, _x.init_pose.header.seq, _x.init_pose.header.stamp.secs, _x.init_pose.header.stamp.nsecs,) = _get_struct_2B3I().unpack(str[start:end])
      self.get_marker.data = bool(self.get_marker.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.init_pose.pose.position.x, _x.init_pose.pose.position.y, _x.init_pose.pose.position.z, _x.init_pose.pose.orientation.x, _x.init_pose.pose.orientation.y, _x.init_pose.pose.orientation.z, _x.init_pose.pose.orientation.w, _x.rail_pose.header.seq, _x.rail_pose.header.stamp.secs, _x.rail_pose.header.stamp.nsecs,) = _get_struct_7d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.rail_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.rail_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.rail_pose.point.x, _x.rail_pose.point.y, _x.rail_pose.point.z, _x.rail_marker_target.header.seq, _x.rail_marker_target.header.stamp.secs, _x.rail_marker_target.header.stamp.nsecs,) = _get_struct_3d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.rail_marker_target.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.rail_marker_target.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 24
      (_x.rail_marker_target.point.x, _x.rail_marker_target.point.y, _x.rail_marker_target.point.z,) = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.scanning_goals = []
      ...
      (_x.path_constraints.orientation_constraint_type, _x.path_constraints.volume_constraint_type, _x.path_constraints.allowed_planning_time, _x.path_constraints.max_retries, _x.path_constraints.replanning_multiplier, _x.path_constraints.max_planning_time,) = _get_struct_2BdB2d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.path_constraints.path_constraints.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.path_constraints.path_constraints.name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.path_constraints.path_constraints.joint_constraints = []
      for i in range(0, length):
        ...
        (_x.position, _x.tolerance_above, _x.tolerance_below, _x.weight,) = _get_struct_4d().unpack(str[start:end])
        self.path_constraints.path_constraints.joint_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.path_constraints.path_constraints.position_constraints = []
      for i in range(0, length):
        ...
        self.path_constraints.path_constraints.position_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.path_constraints.path_constraints.orientation_constraints = []
      for i in range(0, length):
        ...
        (_x.absolute_x_axis_tolerance, _x.absolute_y_axis_tolerance, _x.absolute_z_axis_tolerance, _x.parameterization, _x.weight,) = _get_struct_3dBd().unpack(str[start:end])
        self.path_constraints.path_constraints.orientation_constraints.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.path_constraints.path_constraints.visibility_constraints = []
      for i in range(0, length):
        ...
        (_x.max_view_angle, _x.max_range_angle, _x.sensor_view_direction, _x.weight,) = _get_struct_2dBd().unpack(str[start:end])
        self.path_constraints.path_constraints.visibility_constraints.append(val1)
      return self
