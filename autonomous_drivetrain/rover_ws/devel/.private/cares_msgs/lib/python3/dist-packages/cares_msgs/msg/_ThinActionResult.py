...
"""autogenerated by genpy from cares_msgs/ThinActionResult.msg. Do not edit."""
import codecs
import sys
...
class ThinActionResult(genpy.Message):
  _md5sum = "d2621b3fde8e46ba264bace08d3e9503"
  _type = "cares_msgs/ThinActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/ThinResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ThinActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cares_msgs.msg.ThinResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cares_msgs.msg.ThinResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(_x))
      length = len(self.result.succeeded)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.succeeded:
        _x = val1.ID
        buff.write(_get_struct_B().pack(_x))
        _v1 = val1.centroid
        _x = _v1
      ...
      length = len(self.result.failed)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.failed:
        _x = val1.ID
        buff.write(_get_struct_B().pack(_x))
        _v3 = val1.centroid
        _x = _v3
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.succeeded.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.failed = []
      for i in range(0, length):
        ...
        (_x.radius, _x.chosen_one,) = _get_struct_fB().unpack(str[start:end])
        val1.chosen_one = bool(val1.chosen_one)
        self.result.failed.append(val1)
      return self
