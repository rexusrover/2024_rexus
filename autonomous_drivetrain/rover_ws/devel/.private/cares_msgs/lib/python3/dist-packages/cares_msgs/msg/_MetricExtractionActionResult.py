...
"""autogenerated by genpy from cares_msgs/MetricExtractionActionResult.msg. Do not edit."""
import codecs
import sys
...
class MetricExtractionActionResult(genpy.Message):
  _md5sum = "571bfdb051fb004066656a2cf1363654"
  _type = "cares_msgs/MetricExtractionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/MetricExtractionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MetricExtractionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cares_msgs.msg.MetricExtractionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cares_msgs.msg.MetricExtractionResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(_x))
      length = len(self.result.vine.cane_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.vine.cane_list:
        _x = val1
        ...
        for val3 in _v2.neighbours:
          _x = val3
          buff.write(_get_struct_I2d().pack(_x.neighbour_id, _x.internode_length, _x.internode_width))
      length = len(self.result.fruitlets.fruitlets)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.fruitlets.fruitlets:
        _x = val1.ID
        buff.write(_get_struct_B().pack(_x))
        _v4 = val1.centroid
        _x = _v4
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.result.point_cloud.header.seq, _x.result.point_cloud.header.stamp.secs, _x.result.point_cloud.header.stamp.nsecs))
      _x = self.result.point_cloud.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.result.point_cloud.height, _x.result.point_cloud.width))
      length = len(self.result.point_cloud.fields)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.point_cloud.fields:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self
      buff.write(_get_struct_B2I().pack(_x.result.point_cloud.is_bigendian, _x.result.point_cloud.point_step, _x.result.point_cloud.row_step))
      _x = self.result.point_cloud.data
      length = len(_x)
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.point_cloud.is_dense
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.vine.cane_list.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.fruitlets.fruitlets = []
      for i in range(0, length):
        ...
        self.result.fruitlets.fruitlets.append(val1)
      _x = self
      start = end
      end += 12
      (_x.result.point_cloud.header.seq, _x.result.point_cloud.header.stamp.secs, _x.result.point_cloud.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.point_cloud.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.point_cloud.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.result.point_cloud.height, _x.result.point_cloud.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.result.point_cloud.fields = []
      for i in range(0, length):
        ...
        self.result.point_cloud.fields.append(val1)
      _x = self
      start = end
      end += 9
      (_x.result.point_cloud.is_bigendian, _x.result.point_cloud.point_step, _x.result.point_cloud.row_step,) = _get_struct_B2I().unpack(str[start:end])
      self.result.point_cloud.is_bigendian = bool(self.result.point_cloud.is_bigendian)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.result.point_cloud.data = str[start:end]
      start = end
      end += 1
      (self.result.point_cloud.is_dense,) = _get_struct_B().unpack(str[start:end])
      self.result.point_cloud.is_dense = bool(self.result.point_cloud.is_dense)
      return self
