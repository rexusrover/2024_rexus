...
"""autogenerated by genpy from cares_msgs/ActuationActionResult.msg. Do not edit."""
import codecs
import sys
...
class ActuationActionResult(genpy.Message):
  _md5sum = "f02dd6cee954d6c82790c5f77da6aa86"
  _type = "cares_msgs/ActuationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/ActuationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActuationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cares_msgs.msg.ActuationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cares_msgs.msg.ActuationResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.result.result, _x.result.failure_reason))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.result, _x.result.failure_reason,) = _get_struct_2B().unpack(str[start:end])
      return self
