...
"""autogenerated by genpy from cares_msgs/CutActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class CutActionFeedback(genpy.Message):
  _md5sum = "4f1e89ab953f5e5a7d37a11b65365948"
  _type = "cares_msgs/CutActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/CutFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CutActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cares_msgs.msg.CutFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cares_msgs.msg.CutFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4B().pack(_x.feedback.count, _x.feedback.total, _x.feedback.status, _x.feedback.actuation_feedback.feedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.count, _x.feedback.total, _x.feedback.status, _x.feedback.actuation_feedback.feedback,) = _get_struct_4B().unpack(str[start:end])
      return self
