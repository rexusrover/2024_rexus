...
"""autogenerated by genpy from cares_msgs/ActuationActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ActuationActionFeedback(genpy.Message):
  _md5sum = "b08e44bc93e9187951ce3b949fc8e404"
  _type = "cares_msgs/ActuationActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/ActuationFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActuationActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cares_msgs.msg.ActuationFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cares_msgs.msg.ActuationFeedback()
