...
"""autogenerated by genpy from cares_msgs/ThinAction.msg. Do not edit."""
import codecs
import sys
...
class ThinAction(genpy.Message):
  _md5sum = "57ad36a52cb79efd1f39720ed041205a"
  _type = "cares_msgs/ThinAction"
...
"""
  ...
  _slot_types = ['cares_msgs/ThinActionGoal','cares_msgs/ThinActionResult','cares_msgs/ThinActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ThinAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cares_msgs.msg.ThinActionGoal()
      if self.action_result is None:
        self.action_result = cares_msgs.msg.ThinActionResult()
      if self.action_feedback is None:
        self.action_feedback = cares_msgs.msg.ThinActionFeedback()
    else:
      self.action_goal = cares_msgs.msg.ThinActionGoal()
      self.action_result = cares_msgs.msg.ThinActionResult()
      self.action_feedback = cares_msgs.msg.ThinActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.action_goal.goal.thinning_frame
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.fruitlets)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.fruitlets:
        _x = val1.ID
        buff.write(_get_struct_B().pack(_x))
        _v1 = val1.centroid
        _x = _v1
      ...
      buff.write(_get_struct_B().pack(_x))
      length = len(self.action_result.result.succeeded)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.succeeded:
        _x = val1.ID
        buff.write(_get_struct_B().pack(_x))
        _v3 = val1.centroid
        _x = _v3
        ...
        _x = val1
        buff.write(_get_struct_fB().pack(_x.radius, _x.chosen_one))
      length = len(self.action_result.result.failed)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.failed:
        _x = val1.ID
        buff.write(_get_struct_B().pack(_x))
        _v5 = val1.centroid
        _x = _v5
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.thinning_frame = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.thinning_frame = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.fruitlets = []
      for i in range(0, length):
        ...
        self.action_goal.goal.fruitlets.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.succeeded = []
      for i in range(0, length):
        val1 = cares_msgs.msg.Fruitlet()
        start = end
        end += 1
        ...
        (_x.radius, _x.chosen_one,) = _get_struct_fB().unpack(str[start:end])
        val1.chosen_one = bool(val1.chosen_one)
        self.action_result.result.succeeded.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.failed = []
      for i in range(0, length):
        val1 = cares_msgs.msg.Fruitlet()
        start = end
        end += 1
        ...
        (_x.radius, _x.chosen_one,) = _get_struct_fB().unpack(str[start:end])
        val1.chosen_one = bool(val1.chosen_one)
        self.action_result.result.failed.append(val1)
      _x = self
      start = end
      end += 12
