...
class PlatformGoalGoal(genpy.Message):
  _md5sum = "00c1e19447ee6224b77289215c691270"
...
"""
  ...
  __slots__ = ['link_id','target_pose','command','path_constraints']
  _slot_types = ['std_msgs/String','geometry_msgs/PoseStamped','uint8','cares_msgs/PathPlanningConstraints']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       link_id,target_pose,command,path_constraints
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d3BdB2d().pack(_x.target_pose.pose.position.x, _x.target_pose.pose.position.y, _x.target_pose.pose.position.z, _x.target_pose.pose.orientation.x, _x.target_pose.pose.orientation.y, _x.target_pose.pose.orientation.z, _x.target_pose.pose.orientation.w, _x.command, _x.path_constraints.orientation_constraint_type, _x.path_constraints.volume_constraint_type, _x.path_constraints.allowed_planning_time, _x.path_constraints.max_retries, _x.path_constraints.replanning_multiplier, _x.path_constraints.max_planning_time))
...
def _get_struct_4d():
    ...
    return _struct_4d
_struct_7d3BdB2d = None
def _get_struct_7d3BdB2d():
    global _struct_7d3BdB2d
    if _struct_7d3BdB2d is None:
        _struct_7d3BdB2d = struct.Struct("<7d3BdB2d")
    return _struct_7d3BdB2d
_struct_B = None
def _get_struct_B():
    global _struct_B
