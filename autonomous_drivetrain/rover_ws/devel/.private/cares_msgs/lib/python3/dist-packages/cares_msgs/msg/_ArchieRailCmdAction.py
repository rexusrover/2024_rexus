...
"""autogenerated by genpy from cares_msgs/ArchieRailCmdAction.msg. Do not edit."""
import codecs
import sys
...
class ArchieRailCmdAction(genpy.Message):
  _md5sum = "de568f6522297b6e38a9bce2802ca3de"
  _type = "cares_msgs/ArchieRailCmdAction"
...
"""
  ...
  _slot_types = ['cares_msgs/ArchieRailCmdActionGoal','cares_msgs/ArchieRailCmdActionResult','cares_msgs/ArchieRailCmdActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArchieRailCmdAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cares_msgs.msg.ArchieRailCmdActionGoal()
      if self.action_result is None:
        self.action_result = cares_msgs.msg.ArchieRailCmdActionResult()
      if self.action_feedback is None:
        self.action_feedback = cares_msgs.msg.ArchieRailCmdActionFeedback()
    else:
      self.action_goal = cares_msgs.msg.ArchieRailCmdActionGoal()
      self.action_result = cares_msgs.msg.ArchieRailCmdActionResult()
      self.action_feedback = cares_msgs.msg.ArchieRailCmdActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_feedback.feedback.status, _x.action_feedback.feedback.pose.header.seq, _x.action_feedback.feedback.pose.header.stamp.secs, _x.action_feedback.feedback.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_feedback.feedback.status, _x.action_feedback.feedback.pose.header.seq, _x.action_feedback.feedback.pose.header.stamp.secs, _x.action_feedback.feedback.pose.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
