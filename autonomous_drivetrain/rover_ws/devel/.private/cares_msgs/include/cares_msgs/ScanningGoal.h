...
struct ScanningGoal_
{
  ...
  _command_type command;
   ...
   typedef uint8_t _marker_type_type;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef START
#endif
#if defined(_WIN32) && defined(GET_MARKER)
  #undef GET_MARKER
#endif
  ...
  #undef ACTUATE
#endif
#if defined(_WIN32) && defined(MARKER_ARUCO)
  #undef MARKER_ARUCO
#endif
#if defined(_WIN32) && defined(MARKER_CHARUCO)
  #undef MARKER_CHARUCO
#endif
...
struct MD5Sum< ::cares_msgs::ScanningGoal_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xe318ff248a9956efULL;
  static const uint64_t static_value2 = 0x2cf074c8e1f2c43dULL;
};
...
struct Printer< ::cares_msgs::ScanningGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cares_msgs::ScanningGoal_<ContainerAllocator>& v)
  {
    ...
    s << indent << "marker_type: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.marker_type);
    s << indent << "pose: ";
    s << std::endl;
